  ...
  @section('title')
      Teachers Edit Profile | {{ config('app.name', 'Laravel') }} | Platform for comparing schools in Imo State
  @endsection
                    ...
                    <form class="form-horizontal auth_form" role="form" method="POST" action="{{ route('update-teachers-details', Auth::user()->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            <fieldset class="form-group{{ $errors->has('teacher_name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" id="teacher_name" name="teacher_name" class="form-control" placeholder="Your Full Name" value="{{ old('teacher_name') }}">
                            ...
                            <fieldset class="form-group{{ $errors->has('subjects') ? ' has-error' : '' }}">
                             ...
                             <fieldset>
                                  <label for="experience">Educational Qualification</label>
                                   <select name="experience" class="form-control" id="class">
                                  <option selected disabled>Select an option</option>
                                  <option value="class1">2010</option>
                                  <option value="class2">2011</option>
                                 </select>
                             </fieldset>
                        ...
                        <div class="col-md-6">
                            ...
                            <fieldset id="comment_wrapper" class="form-group{{ $errors->has('comment') ? ' has-error' : '' }}">
                                <label for="comment" class="control-label"> Add Description </label>
                            ...
                            <fieldset>
                            <label for="experience">When did you started Teaching</label>
                            <select name="experience" class="form-control" id="class" multiple>
                               <option selected disabled>Select an option</option>
                               <option value="class1">2010</option>
                                <option value="class2">2011</option>
                            </select>
                            ...
                            <fieldset id="avatar_section" class="form-group{{ $errors->has('avatar') ? ' has-error' : '' }}">
                                <label for="image_input_file" class="control-label">Upload Picture</label>
                        ...
                        <fieldset class="form-group">
                            <div class="">
                                <button type="submit" class="form-control btn btn-success auth_button">
                                    Update
                                </button>
                            </div>
                        </fieldset>
